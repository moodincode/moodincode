 ...
 *
 */
public class WechatUser extends Result implements Serializable {
	private static final long serialVersionUID = -8723573882669618995L;
	/**
	...
	public String toString() {
		return "WechatUser [subscribe=" + subscribe + ", openid=" + openid+ ", unionid=" + unionid
